package com.zhiwen.mq;

import com.zhiwen.dto.MessageDto;
import com.zhiwen.exception.BusinessException;
import com.zhiwen.pojo.MailMessageInfo;
import com.zhiwen.util.MailUtil;
...
public class MsgConsumer {
    ...
    public void receiveMessageMsg(ObjectMessage objectMessage) throws JMSException,
        ...
        sb.append("<h2>有个小伙伴给你留言啦！</h2>")
                ...
                .append("<hr>")
                .append("<a href='http://localhost:8080/toMessagePage'>点此跳转博客留言板页面</a>");
