...
import com.zhiwen.mapper.BlogExtendMapper;
import com.zhiwen.mapper.BlogMapper;
import com.zhiwen.mapper.BlogTagExtendMapper;
...
import com.zhiwen.textrank.TextRankSummary;
import com.zhiwen.util.MarkdownUtils;
...
public class BlogServiceImpl implements BlogService {
    ...
    public void addBlog(Blog blog) {
        ...
        System.out.println(String.join(",", TextRankSummary.getTopSentenceList(blog.getBlogContent(), 5)));
        System.out.println(blog.getBlogDesc());
        //进行简介提取
        if(blog.getBlogDesc() == ""){
            String content = blog.getBlogContent();
            List<String> sentenceList = TextRankSummary.getTopSentenceList(content, 3);
            String blogDes = String.join(",", sentenceList);
            blog.setBlogDesc(blogDes);
//            blogMapper.addTextRank(String.join(",", sentenceList));
        }
